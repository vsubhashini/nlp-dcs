...
def main():
  ...
  #outputLexFile="../data/outputFiles/geobaseLexicon.dlog"
  #outputLexFile="data/geobaseWackyLexicon.dlog"
  outputLexFile="../am_dcs-1.0/lexiconFiles/geobaseWacky10Lexicon.dlog"
  #outputLexFile="../am_dcs-1.0/lexiconFiles/geoqryWacky10Lexicon.dlog"
  #outputLexFile="../am_dcs-1.0/lexiconFiles/geopredWacky10Lexicon.dlog"
